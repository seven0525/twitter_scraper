    ...
    def gen_tweets(pages):
        ...
        while pages > 0:
            ...
            for tweet in html.find('.stream-item'):
                ...
                replies = interactions[0].split(" ")[0].replace(comma, "").replace(dot,"")
                retweets = interactions[1].split(" ")[0].replace(comma, "").replace(dot,"")
...
for tweet in get_tweets('ahpjop', pages=2):
	print(tweet['text'])